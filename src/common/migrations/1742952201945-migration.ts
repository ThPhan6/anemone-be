...
export class Migration1742952201945 implements MigrationInterface {
  name = 'Migration1742952201945';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "devices" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "device_id" character varying NOT NULL, "thing_name" character varying, "provisioning_status" "public"."devices_provisioning_status_enum" NOT NULL DEFAULT 'PENDING', "firmware_version" character varying, "is_connected" boolean NOT NULL DEFAULT false, "last_ping_at" TIMESTAMP, "warranty_expiration_date" TIMESTAMP, "registered_by" character varying, "serial_number" character varying, "space_id" uuid, "family_id" uuid, CONSTRAINT "UQ_2667f40edb344d6f274a0d42b6f" UNIQUE ("device_id"), CONSTRAINT "REL_cc9e89897e336172fd06367735" UNIQUE ("serial_number"), CONSTRAINT "PK_b1514758245c12daf43486dd1f0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
